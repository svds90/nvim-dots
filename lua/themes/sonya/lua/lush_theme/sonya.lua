...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    -- Cursor { fg = "#FFFFFF", gui = "italic" }, -- Character under the cursor
    CurSearch { bg = "#4c6151", fg = "#ffffff", gui = "italic" }, -- Highlighting a search pattern under the cursor (see 'hlsearch')
    ...
    EndOfBuffer { fg = "#262630" }, -- Filler lines (~) after the end of the buffer. By default, this is highlighted like |hl-NonText|.
    -- TermCursor     { }, -- Cursor in a focused terminal
    -- TermCursorNC   { }, -- Cursor in an unfocused terminal
    ErrorMsg { fg = "#a62323", gui = "bold" }, -- Error messages on the command line
    -- VertSplit { fg = "#000000", bg = "#000000" }, -- Column separating vertically split windows
    Folded { bg = "#1f1f29", fg = "#494957", gui = "italic, bold" }, -- Line used for closed folds
    -- FoldColumn     { }, -- 'foldcolumn'
    -- SignColumn     { }, -- Column where |signs| are displayed
    -- IncSearch      { }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
    -- Substitute     { }, -- |:substitute| replacement text highlighting
    LineNr { fg = "#00b6d6", gui = "bold" }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    LineNrAbove { fg = "#4f5054" }, -- Line number for when the 'relativenumber' option is set, above the cursor line
    LineNrBelow { fg = "#4f5054" }, -- Line number for when the 'relativenumber' option is set, below the cursor line
    ...
    NonText { fg = "#5d7064" }, -- '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line). See also |hl-EndOfBuffer|.
    ...
    Search { bg = "#323642", fg = "#7a85a3", gui = "" }, -- Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
    ...
    TabLine { bg = "#343442" }, -- Tab pages line, not active tab page label
    TabLineFill {}, -- Tab pages line, where there are no labels
    TabLineSel {}, -- Tab pages line, active tab page label
    Title { fg = "#bf6817" }, -- Titles for output from ":set all", ":autocmd" etc.
    Visual { bg = "#404052" }, -- Visual mode selection
    -- VisualNOS      { }, -- Visual mode selection when vim is "Not Owning the Selection".
    WarningMsg { fg = "#bdbf1d" }, -- Warning messages
    -- Whitespace     { }, -- "nbsp", "space", "tab" and "trail" in 'listchars'
    Winseparator { fg = "#1e1e24" }, -- Separator between window splits. Inherts from |hl-VertSplit| by default, which it will replace eventually.
    ...
    Comment { fg = "#696969", bg = "", gui = "" }, -- Any comment
